...
public enum Talent {
	...
	//Rogue T2
	MYSTICAL_MEAL(68), INSCRIBED_STEALTH(69), STEALTH_METABOLISM(70), SILENT_STEPS(71), ROGUES_FORESIGHT(72),
	//Rogue T3
	...
	//Cleric T2
	ENLIGHTENING_MEAL(164), RECALL_INSCRIPTION(165), SUNRAY(166), DIVINE_SENSE(167), BLESS(168), SACRED_ARCANE(188),
	//Cleric T3
	...
	public static void initClassTalents( HeroClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents, LinkedHashMap<Talent, Talent> replacements ){
		...
		switch (cls){
			...
			case DUELIST:
				...
				break;
			case CLERIC:
				Collections.addAll(tierTalents, ENLIGHTENING_MEAL, RECALL_INSCRIPTION, SUNRAY, DIVINE_SENSE, BLESS, SACRED_ARCANE);
				break;
		}
		for (Talent talent : tierTalents){
			if (replacements.containsKey(talent)){
