...
public class AscendedForm extends ArmorAbility {
	...
	public Talent[] talents() {
		return new Talent[]{Talent.DIVINE_INTERVENTION, Talent.JUDGEMENT, Talent.FLASH, Talent.HOLY_REGENERATION, Talent.HEROIC_ENERGY};
	}
	...
	public static class AscendBuff extends ShieldBuff {
		...
		public boolean holyRegenerationCast = false;
		...
		public void storeInBundle(Bundle bundle) {
			...
			bundle.put(HOLY_PROTECTION_CAST, holyRegenerationCast);
		}
		...
		public void restoreFromBundle(Bundle bundle) {
			...
			holyRegenerationCast = bundle.getBoolean(HOLY_PROTECTION_CAST);
		}
	}
