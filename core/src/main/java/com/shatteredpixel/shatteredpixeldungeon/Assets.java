...
public class Assets {
	...
	public static class Music {
        ...
        public static final String THEME_OLD            = "music/theme_old.mp3";

        public static final String GAME                 = "music/game.mp3";
        public static final String SURFACE              = "music/surface.mp3";
	...
	public static class Splashes {
		...
		public static final String EXPLORER = "splashes/explorer.png";
		public static final String NEW_HERO = "splashes/newhero.jpg";
	...
	public static class Sprites {
		...
		public static final String BERSERKER= "sprites/berserker.png";
