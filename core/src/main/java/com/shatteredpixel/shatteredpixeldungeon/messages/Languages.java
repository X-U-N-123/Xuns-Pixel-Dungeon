...
public enum Languages {
	ENGLISH("english",      "en", Status.X_UNFINISH, new String[]{"X_U_N"}, null),
	CHINESE("中文",          "zh", Status.O_COMPLETE, null,null),
	...
	DUTCH("nederlands",     "nl", Status.X_UNFINISH, new String[]{"AlbertBrand", "Mvharen"}, new String[]{"AvanLieshout", "Blokheck011", "Frankwert", "Gehenna", "Valco", "ZephyrZodiac", "link200023", "rmw", "th3f4llenh0rr0r"}),
