...
public class ConstantEnergy extends Spell {

	{
		image = ItemSpriteSheet.CON_ENERGY;
	...
	public static class Recipe extends com.shatteredpixel.shatteredpixeldungeon.items.Recipe.SimpleRecipe {
		...
		{
			inputs =  new Class[]{ScrollOfMysticalEnergy.class};
			inQuantity = new int[]{1};

			cost = 8;

			output = ConstantEnergy.class;
