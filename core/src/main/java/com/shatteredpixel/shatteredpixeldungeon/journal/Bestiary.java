...
import com.shatteredpixel.shatteredpixeldungeon.actors.mobs.DemonSentry;
import com.shatteredpixel.shatteredpixeldungeon.actors.mobs.DemonSpawner;
import com.shatteredpixel.shatteredpixeldungeon.actors.mobs.DwarfKing;
import com.shatteredpixel.shatteredpixeldungeon.actors.mobs.EbonyMimic;
import com.shatteredpixel.shatteredpixeldungeon.actors.mobs.Elemental;
import com.shatteredpixel.shatteredpixeldungeon.actors.mobs.Engineer;
...
public enum Bestiary {
	...
	static {
		...
		REGIONAL.addEntities(Rat.class, Snake.class, Gnoll.class, Swarm.class, Crab.class, Slime.class,
				...
				Ghoul.class, Elemental.FireElemental.class, Elemental.FrostElemental.class, Elemental.ShockElemental.class, Warlock.class, Monk.class, Engineer.class, Golem.class,
				RipperDemon.class, DemonSpawner.class, Succubus.class, Resentment.class, DemonSentry.class, Eye.class, Scorpio.class);
		...
		BOSSES.addEntities(Goo.class,
				...
				YogFist.BurningFist.class, YogFist.SoiledFist.class, YogFist.RottingFist.class, YogFist.RustedFist.class,YogFist.BrightFist.class, YogFist.DarkFist.class,
				YogDzewa.class);
		...
		ALLY.addEntities(MirrorImage.class, PrismaticImage.class,
				...
				StoneCudgel.StoneGuardian.class,
				WandOfWarding.Ward.class, WandOfWarding.Ward.WardSentry.class, WandOfLivingEarth.EarthGuardian.class,
				ShadowClone.ShadowAlly.class, SmokeBomb.NinjaLog.class, SpiritHawk.HawkAlly.class, PowerOfMany.LightAlly.class, Detonator.DetonationMob.class);
